var Bridge = {
    ...
    sendSlice: function (nativePath, uploadUrl, offset, sliceSize) {
        Bridge.lastSlice = {
...
TH.Ajax = (function () {
    ...
    publicObj.mock = function (urlToMock, response) {
    
        mockAjaxHash[urlToMock] = response;
        ...
        Ajax.Request = function(url, opts) {
            ...
            if(opts.onComplete) {
                response = {};
                response.responseText = mockAjaxHash[url];
