Screw.Unit(function() {
    describe('MBX.JsTemplate', function() {
        ...
        describe("prerendered templates", function () {
            before(function () {
                TH.insertDomMock('mvc/prerendered_template');
                //MBX.JsTemplate.fetchPreRenderedTemplates();
                MBX.EventHandler.fireCustom(document.body, "domReady");
            });
            
            it("should load the prerendered templates from the DOM", function () {                
